 ...
 * Slug: ucnrs/page-split-cover-text
...
<div class="wp-block-columns alignfull" style="margin-top:0px;margin-bottom:0px">
    ...
    <div class="wp-block-column" style="flex-basis:50%">
        ...
        <div class="wp-block-cover" style="min-height:100vh">
            ...
            <img class="wp-block-cover__image-background wp-image-3485" alt="UCNRS WordPress Theme" src="https://frostwp.com/wp-content/uploads/2021/12/sample-black_1200x1200.jpg" data-object-fit="cover" />
    ...
    <div class="wp-block-column is-vertically-aligned-center" style="padding-top:5%;padding-right:5%;padding-bottom:5%;padding-left:5%;flex-basis:50%">
        ...
        <h2 class="has-x-large-font-size" id="text-on-left-image-on-right"><?php echo esc_html__('Cover on left, text on right.', 'ucnrs'); ?></h2>
        <!-- /wp:heading -->
        <!-- wp:paragraph -->
        ...
        <div class="wp-block-buttons">
            ...
            <div class="wp-block-button is-style-fill"><a class="wp-block-button__link no-border-radius"><?php echo esc_html__('Get Started', 'ucnrs'); ?></a></div>
            <!-- /wp:button -->
